...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private Camera.AutoFocusCallback callback = new Camera.AutoFocusCallback() {
        @Override
    ...
    private  Camera.AutoFocusMoveCallback moveCallback = new Camera.AutoFocusMoveCallback() {
        @Override
...
//            mCameraManager.getCamera().setAutoFocusMoveCallback(moveCallback);
//            mCameraManager.getCamera().autoFocus(callback);
            if (mainHandler == null) {
...
//                Toast.makeText(this, String.valueOf(beepManager.getTimeDuration()), Toast.LENGTH_SHORT).show();
            }else {
//                Toast.makeText(this, "崩溃了", Toast.LENGTH_SHORT).show();
